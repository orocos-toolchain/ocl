...
INCLUDE (${PROJ_SOURCE_DIR}/config/FindPkgConfig.cmake)
	...
	ELSE( CMAKE_PKGCONFIG_EXECUTABLE )
	      ...
	      SET( OROCOS_RTT_${FLAVOR_TARGET_CAP}_LINK_DIRS_1.4 ${OROCOS_INSTALL}/bin )
	      SET( OROCOS_RTT_${FLAVOR_TARGET_CAP}_LIBS_1.4 ${OROCOS_INSTALL}/bin/orocos-rtt-${OROCOS_TARGET}${CMAKE_DEBUG_PREFIX}.dll)
	...
	IF(OROCOS_CORBA_TARGET STREQUAL "${FLAVOR_TARGET}")
	  ...
	  ELSE( CMAKE_PKGCONFIG_EXECUTABLE )
	      ...
	      SET( OROCOS_RTT_CORBA_INCLUDE_DIRS ${OROCOS_INSTALL}/include )
	      SET( OROCOS_RTT_CORBA_DEFINES OROCOS_TARGET=${OROCOS_TARGET} )
	      SET( OROCOS_RTT_CORBA_LINK_DIRS ${OROCOS_INSTALL}/bin )
	      SET( OROCOS_RTT_CORBA_LIBS ${OROCOS_INSTALL}/bin/orocos-rtt-corba-${OROCOS_TARGET}.dll)
	  ENDIF( CMAKE_PKGCONFIG_EXECUTABLE )	
