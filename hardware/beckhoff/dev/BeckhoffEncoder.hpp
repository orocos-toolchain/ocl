...
#ifndef ORO_BECKHOFF_ENCODER_HPP
#define ORO_BECKHOFF_ENCODER_HPP
...
{namespace CAN
{
    class BeckhoffEncoder 
        : public EncoderInterface
    {
        BeckhoffSSI* bhssi;
        unsigned int chan;
    public:
        BeckhoffEncoder( BeckhoffSSI* ssi, unsigned int channel ) : bhssi(ssi), chan(channel) {}
