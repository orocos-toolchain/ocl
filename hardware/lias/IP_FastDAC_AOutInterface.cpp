...
IP_FastDAC_AOutInterface::IP_FastDAC_AOutInterface(const std::string& name) : RTT::AnalogOutInterface(name)
{
...
IP_FastDAC_AOutInterface::IP_FastDAC_AOutInterface() : RTT::AnalogOutInterface()
{
    IP_FastDAC_set_gain_of_group (1, RANGE_10_V);
    IP_FastDAC_set_gain_of_group (2, RANGE_10_V);
    IP_FastDAC_set_gain_of_group (3, RANGE_10_V);
