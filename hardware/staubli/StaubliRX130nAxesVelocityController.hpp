#ifndef STAUBLIRX130_NAXES_VELOCITY_CONTROLLER_HPP
#define STAUBLIRX130_NAXES_VELOCITY_CONTROLLER_HPP
...
namespace OCL
{
     ...
     * StaubliRX130 robot in the RoboticLab, PMA, dept. Mechanical
    ...
    class StaubliRX130nAxesVelocityController : public TaskContext
    {
    public:
        /** 
    ...
    private:
        ...
        DigitalOutput*                           brakeOff;
        DigitalOutput*                           highPowerEnable;
        DigitalInput*                            eStop;
